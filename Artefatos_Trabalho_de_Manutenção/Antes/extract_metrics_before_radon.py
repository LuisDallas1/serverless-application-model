...
cc_data  = rodar_radon(["radon", "cc",  "./samtranslator", "-j"])
print("Rodando radon mi...")
mi_data  = rodar_radon(["radon", "mi",  "./samtranslator", "-j"])
print("Rodando radon hal...")
hal_data = rodar_radon(["radon", "hal", "./samtranslator", "-j"])
print("Rodando radon raw...")
raw_data = rodar_radon(["radon", "raw", "./samtranslator", "-j"])
